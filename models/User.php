...
require 'PHPMailer/SMTP.php';
	...
	class User
	{
		...
		public function newStudentCandidacy($candidacyS,$foto)
		{
			try {
				$data['candidatetype_idfk'] = $candidacyS['candidateType'];
				$data['studentlist_idfk'] = $candidacyS['studentList'];
				$data['photo'] = $foto;
				$data['id_statusfk'] = 1;
...
return $pass;
   ...
   public function sendPasswordRecover($data, $name, $last_name){
        try{
		    $mail = new PHPMailer(true);
		    ...
		    // var_dump($nombre,$apellido,$documento, $correo);
		    // die();
		    ...
		    try{
			    ...
			    // Content
			    $mail->isHTML(true);                                  // Set email format to HTML
			    $mail->Subject = 'REESTABLECIMIENTO DE CLAVE - SI VOTINGO';
			    $mail->Body    = '<!DOCTYPE html>
				<html>
				                                                              ...
				                                                              <td style="width: 700px; text-align: center;">
				                                                                <table style="background-size: 100%; background-position: left top; background-color: transparent; margin: auto;">
				                                                                     <tbody>
				                                                                      <tr>
				                                                                        <td style="text-align: center; color: #e84c3d;">
				                                                              <h1>SI VOTING GO - CAMBIO DE CONTRASEÑA</h1>
				                                                               </td>
				                                                               </tr>
				                                                               <tr>
				                                                              <td style="text-align: center; margin: auto;">
				                                                                    <img src="https://i.postimg.cc/KYvqhxXd/logoo.png">
				                                                                         <h2 style="font-size: 35px; font-weight: 900; color: #1624a1">Querid@ 
				                                                                      <span style="color: #e84c3d; font-style: italic;">'.$nombre.' '.$apellido.'</span>¡</h2>
				                                                                      <h2 style="font-size: 35px; font-weight: 900; color: #1624a1">Identificación 
				                                                                      <span style="color: #e84c3d; font-style: italic;">'.$documento.'</span></h2>
				                                                                                    </td>
				                                                                                </tr>
				                                                                            </tbody>
				                                                                        </table>
				                                                                    ...
				                                                                    <td>
				                                                                        <table style=" padding: 5%;">
				                                                                            <tbody style="color: #fff; text-align: justify;">
				                                                                                <tr>
				                                                                                    <td>
				                                       			   										<p>Usted ha solicitado un reestablecimiento de contraseña, ingrese a este link si fue usted el que realizó la petición, de lo contrario ignore este correo</p>
				                                                                                    </td>
				                                                                                </tr>
				                                                                                <tr>
				                                                                                    <td>
				                                                    <a style="font-size: 20px; color: #fff; text-decoration: none;" href="http://localhost/SGVOTINGO/?controller=login&method=changePassword">Confirmar cambio de contraseña.</a>
				                                                        <p style="font-size: 12px; color: #fff">Feliz dia - El equipo de Voting GO¡</p>
				                                                                                    </td>
				                                                                                </tr>
				                                                                            </tbody>
    ...
    public function updateChangePassword($newPassword,$currentPassword){
          try {
                $data=$newPassword;
                $data2=$currentPassword;
                $strWhere =$_SESSION['user']->id;
                /* MySQL Conexion*/
                $link = mysqli_connect("localhost", "root", '', "si_votingo");
                // Chequea coneccion
